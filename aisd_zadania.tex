...
\item[3] Niech $|c_1 - c_i| = p$, $|c_i - d_1| = q$, $|d_1 - d_i| = r$. Więc $|d_1 - c_1| + |d_i - c_i| = p + q + q + r$, natomiast $|d_1 - c_i| + |d_1 - c_i| = p + q + r + q = p + 2q + r$. W tym przypadku wybór będzie taki sam, ale na pewno nie będzie gorszy.
\end{itemize}
